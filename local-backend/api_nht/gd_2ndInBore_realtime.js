...
const DATABASE_ALARM = `[data_machine_gd2].[dbo].[DATA_ALARMLIS_${processName.toUpperCase()}]`;
...
// MQTT connect
const client = mqtt.connect(`mqtt://${process.env.NHT_MQTT_MC_SHOP}:${process.env.MQTT_PORT}`);
client.on("connect", () => {
