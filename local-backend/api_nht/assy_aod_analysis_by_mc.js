...
const DATABASE_PROD = "[data_machine_aod].[dbo].[DATA_PRODUCTION_AOD]";
const DATABASE_ALARM = "[data_machine_aod].[dbo].[DATA_ALARMLIS_AOD]";
const DATABASE_STATUS = "[data_machine_aod].[dbo].[DATA_MCSTATUS_AOD]";
const DATABASE_IOT = "[data_machine_aod].[dbo].[MONITOR_IOT]";
const DATABASE_MASTER = "[data_machine_aod].[dbo].[DATA_MASTER_AOD]";

const COLUMN_OK = "[ok_prod]";
const COLUMN_NG = "[ng_prod]";
