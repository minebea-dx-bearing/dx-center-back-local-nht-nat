...
const DATABASE_PROD = "[data_machine_an2].[dbo].[DATA_PRODUCTION_AN]";
const DATABASE_ALARM = "[data_machine_an2].[dbo].[DATA_ALARMLIS_AN]";
const DATABASE_STATUS = "[data_machine_an2].[dbo].[DATA_MCSTATUS_AN]";
const DATABASE_IOT = "[data_machine_an2].[dbo].[MONITOR_IOT]";
const DATABASE_MASTER = "[data_machine_an2].[dbo].[DATA_MASTER_AN]";

const COLUMN_OK = "([ok1] + [ok2])";
const COLUMN_NG = "([ag] + [ng] + [mix])";
const COLUMN_TOTAL = `(${COLUMN_OK} + ${COLUMN_NG})`;
const COLUMN_CT = "[cycle]";
